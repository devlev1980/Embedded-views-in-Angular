...
export class AppComponent implements AfterViewInit {
    ...
    ngAfterViewInit(): void {
        ...
        this.renderer.removeChild(this.hostElement.nativeElement, this.title.nativeElement) //Dont't do this(Structure manipulation with Renderer)!!! Only with 3-ty part component
